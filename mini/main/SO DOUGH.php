    ...
    <div class="products">
      <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;โดนัทนู่มมมมมมมสไตล์ญี่ปุ่น~ ที่นุ่มจริงนุ่มจังที่ต้องมาลองงับให้หายหมั่นเขี้ยวซักทีนึง!! โดนัทจากนมฮอกไกโดนุ่มๆจิ้มกับดิปหลายรสของทางร้าน คือเข้ากันมากกกกก ชอบสุดคือชาไทยเลย หรือใครชอบโดนัทเเบบมีไส้ร้านนี้ก็ตอบโจทย์นะ ไส้จะเป็นมาสคาโปนหอมๆนมๆครีมๆ เข้ากับโดนัทนุ่มๆหอมนมอยู่เเล้วได้เเบบโป๊ะเชะ!!
<br></h5>
            ...
            <div class="col-md-4">
              ...
              <a href="blog-details.html" class="services-item-image"><img src="assets/images/🍩SO DOUGH.jpg" class="img-fluid" alt=""></a></div>
