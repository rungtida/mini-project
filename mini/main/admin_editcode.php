        ...
        <div class="row">
            ...
            <form  action="admin_editcode.php" method="post">
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    $sql_1 = "SELECT * FROM point WHERE code ='$_REQUEST[update_code]'";
                    @$query = mysqli_query($conn, $sql_1);
                    @$rs = mysqli_fetch_array($query);
                    ?>
                      ADMIN<input name="adminname" type="text" class="form-control"  value="<?php echo $rs['adminname']; ?>" readonly>
                    </fieldset>
                  </div>
                  ...
                  <div class="col-sm-6">
                    <fieldset>
                      ...
                      CODE<input name="code" type="text" class="form-control"  value="<?php echo $_REQUEST['update_code']; ?>" readonly>
                    </fieldset>
                  </div>
                  ...
                  <div class="col-sm-6">
                    <fieldset>
                      POINT<input name="point" type="text" class="form-control"   value="<?php echo $rs['point']; ?>" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-6">
                    <fieldset>
                    
                      วันผลิต<input  name="mfd" type="date" class="form-control"  value="<?php echo $rs['mfd']; ?>" readonly>
                    </fieldset>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-6">
                    <fieldset>
                      วันหมดอายุ<input name="exp" type="date" class="form-control"  value="<?php echo $rs['exp']; ?>" required="">
                    </fieldset>
                  </div>

                  <div class="col-sm-6">
                  <fieldset>
                      <select name = "codestatus" class="form-control">
                ...
                if (isset($_POST['update'])) {
                  ...
                  @$sql1 = "UPDATE point
                  SET adminname ='$adminname',point='$point',mfd='$mfd',exp='$exp',codestatus = '$codestatus' 
                  WHERE code='$code'";
                  ...
                  if (mysqli_query($conn, $sql1)) {
                    ...
                    echo "<script>alert('อัปเดทข้อมูลเรียบร้อย');window.location='admin_searchcode.php';</script>";
                  } else {
          ...
          <div class="col-md-4">
           <!-- <img src="assets/images/team_05.jpg" class="img-fluid" alt="">
            ...
            <h5 class="text-center" style="margin-top: 15px;">SO EUN<3</h5>-->
          </div>
        </div>
      </div>
    </div>
