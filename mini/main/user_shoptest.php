...
<?php echo "<h4 align = right>";
    ...
    $sql = "SELECT * FROM shop LIMIT 6 OFFSET 0;";
    $run = $conn->query($sql);
...
?>
              ...
              <div class="col-md-12">
                ...
                <ul class="pages">
                <li class="active"><a href="user_shoptest.php">1</a></li>
                  <li><a href="user_shoptest2.php">2</a></li>
                  
                  <li><a href="user_shoptest2.php"><i class="fa fa-angle-double-right"></i></a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            ...
            <form  action="user_shoptest.php" method="post">
