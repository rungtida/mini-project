...
<body class = "frame" onload="showscroll()">
  ...
  <?php echo "<h4 align = right>";
    ...
    <div class="send-message">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <form action="admin_insertshop.php" method="post" name="formUserData" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <fieldset>
                      <input name="shopname" type="text" class="form-control"  placeholder="shopname" required="">
                    </fieldset>
                  </div>
                  <div class="col-sm-12">
                    <fieldset>
                      Pic<input name="fileUpload" type="file" class="form-control"  placeholder="" required="">
                    </fieldset>
                  </div>
                  <div class="col-sm-12">
                    <fieldset>
                      <textarea name="shopdetail" type="text" class="form-control"  placeholder="detail" required=""></textarea>
                    </fieldset>
                  </div>
                  <div class="col-sm-12">
                    <fieldset>
                      Link<input name="fileUpload2" type="file" class="form-control"  placeholder="" required="">
                    </fieldset>
                  </div>
            ...
            if (isset($_POST['add'])) {
              ...
              $detail = $_POST['shopdetail'];
             

              
        @$sql2 = "SELECT MAX(shopid) AS shopid FROM shop";
        @$query = mysqli_query($conn,$sql2);
        @$rs = mysqli_fetch_array($query);
        if($rs['shopid'] !=""){
            $sub = substr($rs['shopid'],-3)+1;  
            $id = sprintf('S%03d', $sub);
      ...
      $filepath2 =  $_FILES["fileUpload2"]["name"];
      // แสดงชื่อไฟล์ที่ upload มา
      move_uploaded_file($_FILES["fileUpload2"]["tmp_name"], $filepath2);
      //ย้ายไฟล์จาก temp มาเก็บใน path ที่เรากำหนด คือ $filepath
              ...
              @$sql1 = "INSERT INTO shop(shopid,shopname,shoppic,shopdetail,shoplink) 
        VALUES('$id','$name','$filepath','$detail','$filepath2')";
              // echo $sql1."<br>";
              echo "<center><br>";
              echo "<font color='white'>";
              if (mysqli_query($conn, $sql1)) {
                
                echo "<script>alert('บันทึกข้อมูลเรียบร้อย');window.location='admin_insertshop.php';</script>";
              } else {
          ...
          <div class="col-md-4">
          <!--  <img src="assets/images/samsantech.jpg" class="img-fluid" alt="">

            <h5 class="text-center" style="margin-top: 15px;">SAMSANTECH <3</h5>-->
          </div>
