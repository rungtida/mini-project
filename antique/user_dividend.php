...
<a href="user_receive2.php?update_id=<?php echo $rs_2['id']; ?>"> <input type=button value='หน้าของฉัน' size='40'></a>

<form action="user_dividend.php?update_id=<?php echo $_REQUEST['update_id']; ?>" method="post">
