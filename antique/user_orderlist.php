...
<a href="user_receive2.php?update_id=<?php echo $_GET['update_id'];?>"> <input type=button value='หน้าของฉัน' size='40'></a>
<body>
<style>
...
<form action="user_orderlist.php?update_id=<?php echo $_GET['update_id'];?>" method="post">

<center>
<div class="container">
  <h2>โปรแกรมรับซื้อขยะ</h2>
  <p>ตารางแสดงรายการออร์เดอร์ของฉัน ประจำเดือน
  <select name="month">
...
<tr>
                ...
                <td><a href="user_summary.php?update_id=<?php echo $row["rid"];?>">สรุปการขาย</a></td>
   </tr>
