...
<form name= product.php action="order.php" method="post">
...
<input type="hidden" value="<?php echo $_REQUEST['update_id'];?>" name = "mid" >
<input type="hidden" value="<?php echo $rs['name'];?>" name = "name" >
</table>
 <td><input type="submit" id="submit" name = "save"value="คิดราคา"/></a></td>
 <a href="receive2.php"><input type="button" name="back" value="ถอยกลับ"> </a>
</tbody>
</table>
</div>
</form>
