    ...
    <body>
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light">
                                ...
                                <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item active">
                                            <a class="nav-link active" href="admin_order.php">Orders</a>
                                        </li>
        ...
        <section class="contact-section section_padding">
            <div class="container">
                ...
                <form action="admin_order.php" method="post" name="formUserData" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="contact-title">Orders</h2>
                        </div>
                        <div class="col-lg-8">
                            <form class="form-contact contact_form" action="admin_order.php" method="post" id="contactForm" novalidate="novalidate">
                                <div class="row">
                                    <div class="col-sm-6">
                        ...
                        if (isset($_POST['search'])) {
                            ...
                            if($txtKeyword != "") {
                                //error_reporting(E_ALL ^ E_NOTICE);
                                                       $query = "SELECT * FROM orders WHERE (order_date LIKE '%".$_POST["txtKeyword"]."%' 
                                                                                          or order_fullname LIKE '%".$_POST["txtKeyword"]."%' or order_address LIKE '%".$_POST["txtKeyword"]."%'
                                                                                          or order_phone LIKE '%".$_POST["txtKeyword"]."%' )";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="admin_detailorder.php?update_id=<?php echo $row["id"];?>">รายละเอียด</a></td>
                                                    </tr>
                                                <?php $i++;
                                                    }
                            }else{
