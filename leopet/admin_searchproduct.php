    ...
    <body>
        ...
        <section class="contact-section section_padding">
            <div class="container">
                ...
                <form action="admin_searchproduct.php" method="post" name="formUserData" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="contact-title">Search Product</h2>
                        </div>
                        <div class="col-lg-8">
                    ...
                    <?php
                        ...
                        if (isset($_POST['search'])) {
                            ...
                            if($txtKeyword != "") {
                                ...
                                $query = "SELECT * FROM products WHERE (product_code LIKE '%".$_POST["txtKeyword"]."%' or product_name LIKE '%".$_POST["txtKeyword"]."%' 
                                         or product_desc LIKE '%".$_POST["txtKeyword"]."%' or product_price LIKE '%".$_POST["txtKeyword"]."%' )";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="admin_editproduct.php?update_id=<?php echo $row["id"];?>">แก้ไข</a></td>
                                                        <td><a href="admin_deletepro.php?delete_id=<?php echo $row["id"];?>">ลบ</a></td>
                                                    </tr>
                                                <?php $i++;
                                                    }
                            }else{
