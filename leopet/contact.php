                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col-8 col-md-8 col-xl-6 ">
                          <div class="sub_header_social_icon float-right">
                            ...
                            <a href="login.php" class="btn_1 d-none d-md-inline-block">Sign In</a>
                          </div>
                        </div>
                    </div>
                </div>
  ...
  <section class="contact-section section_padding">
    <div class="container">
      <div class="d-none d-sm-block mb-5 pb-4">
          <center><div class="mapouter"><div class="gmap_canvas"><iframe width="720" height="350" id="gmap_canvas" src="https://maps.google.com/maps?q=rmutk%20thailand&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.embedgooglemap.net/blog/nordvpn-coupon-code/"></a></div><style>.mapouter{position:relative;text-align:right;height:350px;width:720px;}.gmap_canvas {overflow:hidden;background:none!important;height:350px;width:720px;}</style></div>
</center>
<form action="contact_success.php" method="post" name="formUserData" enctype="multipart/form-data">
      <div class="row">
        <div class="col-12"><br><br><br><br>
          <h2 class="contact-title">Get in Touch</h2>
        </div>
        <div class="col-lg-8">
          <form class="form-contact contact_form" action="contact_success.php" method="post" id="contactForm"
            ...
            <div class="row">
                <div class="col-sm-12">
                  ...
                  <div class="col-12">
                      <div class="form-group">
                          <select class="form-control" name="subject" id="subject" onfocus="this.placeholder = ''"
                    ...
                    <div class="row justify-content-center ">
                            <div class="col-lg-8 col-xl-6">
                                <div class="subscribe_part_text text-center">
                                    ...
                                    <p>กรอกอีเมลเพื่อติดตามข่าวสารจากทางเราก่อนใคร ได้ใน inbox ของคุณ.</p>
                                    <div class="subscribe_form">
                                        <form action="#" name="#">
                                            <div class="input-group align-items-center">
                                                <input type="email" class="form-control" placeholder="enter your email">
                                                <div class="subscribe_btn input-group-append">
                                                    <a href="thankyou.php"><div class="btn_1">ยืนยัน</div></a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
