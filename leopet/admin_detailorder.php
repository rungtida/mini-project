  ...
  <body>
    ...
    <section class="contact-section section_padding">
            <div class="container">
                ...
                <form action="admin_detailorder.php" method="post" name="formUserData" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-12">
                        ...
                        include("conn/connectdb.php");
                            ...
                            ?>
                                                ...
                                                $i++;
                                                    ...
                                                    $query = "SELECT * FROM order_details WHERE order_id ='$_REQUEST[update_id]'";
