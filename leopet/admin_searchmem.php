    ...
    <body>
        ...
        <section class="contact-section section_padding">
            <div class="container">
                ...
                <form action="admin_searchmem.php" method="post" name="formUserData" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="contact-title">Search Member</h2>
                        </div>
                        <div class="col-lg-8">
                            <form class="form-contact contact_form" action="admin_editmem.html" method="post" id="contactForm" novalidate="novalidate">
                                <div class="row">
                                    <div class="col-sm-6">
                        ...
                        if (isset($_POST['search'])) {
                            ...
                            if($txtKeyword != "") {
                                //error_reporting(E_ALL ^ E_NOTICE);
                                                       $query = "SELECT * FROM member WHERE (memid LIKE '%".$_POST["txtKeyword"]."%' or username LIKE '%".$_POST["txtKeyword"]."%' 
                                                                                          or name LIKE '%".$_POST["txtKeyword"]."%' or surname LIKE '%".$_POST["txtKeyword"]."%'
                                                                                          or email LIKE '%".$_POST["txtKeyword"]."%' or tel LIKE '%".$_POST["txtKeyword"]."%'
                                                                                          or memstatus LIKE '%".$_POST["txtKeyword"]."%' )";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['memstatus']; ?></td>
                                                        <td><a href="admin_editmem.php?update_id=<?php echo $row["memid"];?>">แก้ไข</a></td>
                                                        <td><a href="admin_delete.php?delete_id=<?php echo $row["memid"];?>">ลบ</a></td>
                                                    </tr>
                                                <?php $i++;
                                                    }
                            }else{
