    ...
    <div class="products">
      <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ร้านซอฟเสิร์ฟเทพๆที่มีเครื่องดื่มที่อร่อยมากด้วยยยย ซอฟเสิร์ฟมัทฉะหอมทะลุโพรงจมูกออกหูออกปาก ซอฟเสิร์ฟสตรอว์เบอร์รี่กับเพิร์ลลิ้นจี่เปรี้ยวๆหวานๆหอมๆก็ดีย์มาก ตบด้วยเครื่องดื่มไวท์ช็อกมัทฉะคือฟินสุดพลัง เเค่ร้านนี้ร้านเดียวก็คุ้มพร้อมกลับบ้านเเล้ว
<br></h5>
            ...
            <div class="col-md-4">
              ...
              <a href="blog-details.html" class="services-item-image"><img src="assets/images/🍵UHOLIC.jpg" class="img-fluid" alt=""></a></div>
