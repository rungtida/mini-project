      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <form action="admin_editshop.php" method="post" name="formUserData" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-sm-12">
                    <fieldset>
                    <?php include("../connect.php");
                    $sql_1 = "SELECT * FROM shop WHERE shopid ='$_REQUEST[update_shopid]'";
                    @$query = mysqli_query($conn, $sql_1);
                    @$rs = mysqli_fetch_array($query);
                    ?>
                      SHOP ID<input name="shopid" type="text" class="form-control"  value="<?php echo $_REQUEST['update_shopid']; ?>" readonly>
                    </fieldset>
                  </div>
                  ...
                  <div class="col-sm-12">
                    <fieldset>
                      ...
                      SHOP NAME<input name="shopname" type="text" class="form-control"  value="<?php echo $rs['shopname']; ?>" required>
                    </fieldset>
                  </div>
                  ...
                  <div class="col-sm-12">
                    <fieldset>
                      DETAIL<textarea name="shopdetail" type="text" class="form-control"  value="<?php echo $rs['shopdetail']; ?>" required=""></textarea>
                    </fieldset>
                  </div>
                ...
                if (isset($_POST['update'])) {
                  ...
                  @$sql1 = "UPDATE shop
                  SET shopname ='$shopname',shoppic='$filepath',shopdetail='$shopdetail'
                  WHERE shopid='$shopid'";
                  ...
                  if (mysqli_query($conn, $sql1)) {
                    ...
                    echo "<script>alert('บันทึกข้อมูลเรียบร้อย');window.location='admin_searchshop.php';</script>";
                  } else {
