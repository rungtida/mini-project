          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="user_shop.php">Shop
                      <span class="sr-only">(current)</span>
                    </a>
                </li> 
    ...
    <div class="products">
      <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ร้านนี้ไม่ต้องพูดเยอะ อีกร้านเทพซอฟครีมพรีเมียมสุดขีดพลัง รอบนี้ออก เมนูใหม่เป็น "Canelé Soft Cream" คาเนเล่ขนมจากฝรั่งเศส กรอบๆหนึบๆหอมวานิลลา มาเจอกับซอฟครีมนมหอมหวานฉ่ำๆของร้านนี้คือเด็ดมากต้องไปลอง เมนูนี้บอกเลยว่า ครีเอทดีงาม หน้าตาน่ากิน เหมาะแก่การถ่ายรูปมาก ๆ ส่วนซอฟครีมตัวอื่นในร้านก็ จิ้มไปเลยซักอันนึงอ่ะเทพหมดเชื่อหมอ อร่อยมากโดยเฉพาะโคนอ่ะเทพจริงไม่เหมือนใครเลย~ <br></h5>
            ...
            <div class="col-md-4">
              ...
              <a href="blog-details.html" class="services-item-image"><img src="assets/images/HOKKAIDO SOFTKREAM.jpg" class="img-fluid" alt=""></a></div>
