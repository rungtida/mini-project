        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="contact-form">
              <form  action="admin_searchshop.php" method="post">
                        ...
                        if (isset($_POST['search'])) {
                            ...
                            if($txtKeyword != "") {
                              //error_reporting(E_ALL ^ E_NOTICE);
                                                       $query = "SELECT * FROM shop WHERE (shopid LIKE '%".$_POST["txtKeyword"]."%' or shopname LIKE '%".$_POST["txtKeyword"]."%' 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src = "<?php echo $row['shoppic']; ?>"width="250" height="250"></td>
                                                        <td><?php echo $row['shopdetail']; ?></td>
                                                        
                                                        
                                                        <td><a href="admin_editshop.php?update_shopid=<?php echo $row["shopid"];?>">แก้ไข</a></td>
                                                        <td><a href="admin_deleteshop.php?delete_shopid=<?php echo $row["shopid"];?>">ลบ</a></td>
                                                    </tr>
                                                <?php $i++;
                                                    }
                            }else{
